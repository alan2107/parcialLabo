...
static int auxGetInt(int* auxEntry) {
	...
	char buffer[11];
	if(auxEntry != NULL &&
	   !getString(buffer, sizeof(buffer)) && !utn_isInt(buffer, sizeof(buffer))) {
...
static int auxGetFloat(float* auxEntry) {
	...
	char buffer[21];
	if(auxEntry != NULL &&
	   !getString(buffer, sizeof(buffer)) && !utn_isFloat(buffer, sizeof(buffer))) {
...
static int auxGetIden(char* auxEntry, int lenght) {
	...
	if(auxEntry != NULL && lenght > 0) {
		if(!getString(buffer, sizeof(buffer)) && !utn_isIden(buffer, sizeof(buffer)) &&
...
static int auxGetName(char* auxEntry, int lenght) {
	...
	char buffer[512];
	if(auxEntry != NULL && lenght > 0) {
		if(!getString(buffer, sizeof(buffer)) && !utn_isName(buffer, sizeof(buffer)) &&
		   strnlen(buffer, sizeof(buffer)) <= lenght) {
			strncpy(auxEntry, buffer, lenght);
			Return = 0;
		}
...
static int auxGetCode(char* auxEntry, int lenght) {
	...
	char buffer[10];
	if(auxEntry != NULL && lenght > 0) {
		if(!getString(buffer, sizeof(buffer)) && !utn_isCode(buffer, sizeof(buffer)) &&
		   strnlen(buffer, sizeof(buffer)) <= lenght) {
			strncpy(auxEntry, buffer, lenght);
			Return = 0;
		}
...
static int auxGetText(char* auxEntry, int lenght) {
	...
	char buffer[1024];
	if(auxEntry != NULL && lenght > 0) {
		if(!getString(buffer, sizeof(buffer)) && !utn_isText(buffer, sizeof(buffer)) &&
		   strnlen(buffer, sizeof(buffer)) <= lenght) {
			strncpy(auxEntry, buffer, lenght);
			Return = 0;
		}
